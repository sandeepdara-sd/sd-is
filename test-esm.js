...
console.log('smartCheck.isEmptyObject({}):', smartCheck.isEmptyObject({}));
console.log('listFunctions():\n', listFunctions());
console.log('isBoolean():', isBoolean()); // false
console.log('smartCheck.isBoolean(true):', smartCheck.isBoolean(true));
console.log('assertType("hello", "string"):', assertType('hello', 'string'));
...
// ----------- PROMISE TYPE CHECK -----------
console.log('\n⚙️ Promise Type Check');
console.log('smartCheck.isPromise(Promise.resolve()):', smartCheck.isPromise(Promise.resolve()));

// ----------- SYNC FLOW VALIDATION TEST -----------
console.log('\n🔄 Flow Step Validation Test');
...
import { createFlow } from './index.js'; // make sure createFlow is exported from index.js
